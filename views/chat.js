...
async function displayGroup(data){
        ...
        chatHeader.addEventListener('click', async ()=>{
            ...
            exitGroupBtn.id = 'exitgroupbtn';
                exitGroupBtn.addEventListener('click', async ()=>{
                    try{
                        const response = await axios.delete(`http://localhost:3000/group/exitGroup/${activeGroupId}/${userId}`, {headers: {Authorization: usertoken}})
            ...
            try{
                const response = await axios.delete(`http://localhost:3000/group/deleteGroup/${activeGroupId}`, {headers: {Authorization: usertoken}})
   ...
   async function displayGroupMembers(activeGroupId){
        ...
        try{
            const response = await axios.get(`http://localhost:3000/group/fetchGroupUsers/${activeGroupId}`, {headers: {Authorization: usertoken}})
...
function showUserOnScreen(res){
    ...
    makeAdminBtn.addEventListener('click', async ()=>{
        try{
            const response = await axios.post(`http://localhost:3000/group/makeAdmin/${activeGroupId}/${userId}`, {}, {headers: {Authorization: usertoken}})
